"""
Django settings for test_app1_2 project.
...
WSGI_APPLICATION = 'test_app1_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_app1_2 API",
    "DESCRIPTION": "API documentation for test_app1_2 App",
    "VERSION": "v1",
}
